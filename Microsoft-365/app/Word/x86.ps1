...
$new_app.Copyright = "Copyright (c) 1983-$((Get-Date).ToString('yyyy')) Microsoft. All rights reserved."
...
$new_app.Summary = "Elevate your writing, create beautiful documents, and collaborate with others—anywhere, anytime."
