...
$new_app.Copyright = "Copyright (c) 1997-$((Get-Date).ToString('yyyy')) Microsoft. All rights reserved."
...
$new_app.Summary = "Connect, organize, and get things done with free personal email and calendar."
