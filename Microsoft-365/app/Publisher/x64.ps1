...
$new_app.Copyright = "Copyright (c) 1991-$((Get-Date).ToString('yyyy')) Microsoft. All rights reserved."
...
$new_app.Summary = "Precisely layout and style text, pictures, borders, calendars, and more with Publisher."
