<# variables #>
$app = "Enterprise Standard Current"
...
if ($IsMacOS)
{
    $o365_config_xml = "/tmp/Configuration.xml"
}
...
if (-not(Test-Path -Path $o365_config_xml))
{
    ...
    if ($IsWindows) { New-Item -Path C:\tmp -ItemType Directory -Name "office365" -Force -Confirm:$false }
