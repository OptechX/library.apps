...
$new_app.Copyright = "Copyright (c) 1987-$((Get-Date).ToString('yyyy')) Microsoft. All rights reserved."
...
$new_app.Summary = "Manage complex mathematics, financial figures or data with Excel."
