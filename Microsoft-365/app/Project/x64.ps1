...
$new_app.Copyright = "Copyright (c) 1984-$((Get-Date).ToString('yyyy')) Microsoft. All rights reserved."
...
$new_app.Summary = "Meet the simple, powerful, reimagined Project for everyone."
