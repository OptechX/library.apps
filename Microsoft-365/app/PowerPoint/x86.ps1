...
$new_app.Copyright = "Copyright (c) 1990-$((Get-Date).ToString('yyyy')) Microsoft. All rights reserved."
...
$new_app.Summary = "Create well-designed, impactful slides with the help of Designer and Ideas in PowerPoint."
