...
$new_app.Name = "Firefox Developer Edition"
$new_app.Lcid = @("EN_US")
$new_app.CpuArch = @("x86")
...
$new_app.Icon = "https://github.com/OptechX/library.apps.images/raw/main/$($Env:applicationCategory)/Mozilla/Firefox%20Developer%20Edition/icon.svg".Replace(" ","%20")
...
$new_app.Tags = @("browser","mozilla","firefox","dev","developer","edition")
$new_app.Summary = "Developer edition of Mozilla Firefox."
...
else
{
    ...
    $rgx = "download.mozilla.*product=firefox-devedition.*(&amp;|&)os=win(&amp;|&)lang=en-US"
