...
$new_app.Icon = "https://github.com/OptechX/library.apps.images/raw/main/$($Env:applicationCategory)/Mozilla/Firefox%20Beta/icon.svg".Replace(" ","%20")
...
$new_app.Tags = @("browser","mozilla","firefox","beta")
$new_app.Summary = "Beta release of Mozilla Firefox."
...
else
{
    ...
    $rgx = "download.mozilla.*product=firefox-beta-msi-latest-ssl.*(&amp;|&)os=win64(&amp;|&)lang=en-US"
