...
$new_app.Icon = "https://github.com/OptechX/library.apps.images/raw/main/$($Env:applicationCategory)/Google/Chrome%20Beta/icon.svg"
...
{
    $version_url = 'https://omahaproxy.appspot.com/all?os=win&amp;channel=beta'
    ...
    $download_url = 'https://dl.google.com/tag/s/dl/chrome/install/beta/googlechromebetastandaloneenterprise64.msi'
