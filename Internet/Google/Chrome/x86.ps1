...
$new_app.Icon = "https://github.com/OptechX/library.apps.images/raw/main/$($Env:applicationCategory)/Google/Chrome/icon.svg".Replace(" ","%20")
...
$new_app.Tags = @("google","chrome","internet","browser")
$new_app.Summary = "Chrome is a fast, simple, and secure web browser, built for the modern web."
...
{
    $version_url = 'http://omahaproxy.appspot.com/all?os=win&amp;channel=stable'
    ...
    $download_url = 'https://dl.google.com/tag/s/dl/chrome/install/googlechromestandaloneenterprise.msi'
