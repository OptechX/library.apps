...
$new_app.Icon = "https://github.com/OptechX/library.apps.images/raw/main/$($Env:applicationCategory)/git/git%20for%20Windows/icon.svg".Replace(" ","%20")
...
else
{
    ...
    $new_app.Filename = "Git-$($new_app.Version)-32-bit.exe"
    $new_app.AbsoluteUri = "https://github.com/git-for-windows/git/releases/download/v$($new_app.Version).windows.1/Git-$($new_app.Version)-32-bit.exe"
