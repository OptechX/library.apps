...
$m365_version = "<Business|Enterprise>"
$m365_channel = "<Current|Monthly-Enterprise|Semi-Annual-Enterprise>"
$m365_build = "<All|Standard|Project|Visio>"
$m365_project_base = "https://raw.githubusercontent.com/OptechX/library.apps/main/Microsoft/Microsoft%20365"
...
$new_app.Name = "Business|Enterprise Standard|Project|Visio|All Current|Monthly Enterprise|Semi-Annual Enterprise"
$new_app.Lcid = @("MUI")
$new_app.CpuArch = @("x64")
...
$new_app.Icon = "$($m365_project_base)/$($m365_version)/$($m365_channel)/$($m365_build)/logo.svg"
...
$new_app.Summary = "Microsoft 365 is a product family of productivity software, collaboration and cloud-based services owned by Microsoft."
...
{
    $json_uri = "$($m365_project_base)/config.json"
    ...
    $new_app.Filename = "install_m365_script.ps1"
    $new_app.AbsoluteUri = "$($m365_project_base)/$($m365_version)/$($m365_channel)/$($m365_build)/$($new_app.Filename)"
