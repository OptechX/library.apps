...
else
{
    ...
    $new_app.Version = $download_page.Content |
        ...
        Select-Object -ExpandProperty Matches -First 1 |
        Select-Object -ExpandProperty Value
    $new_app.Filename = "dotnet-sdk-$($new_app.Version)-win-x86.exe"
    $rgx = "<a href=`"https:\/\/..`*dotnet-sdk-$($new_app.Version)-win-x86.exe"
    $new_app.AbsoluteUri = Invoke-WebRequest -Uri "https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/sdk-$($new_app.Version)-windows-x86-installer" | 
        Select-Object -ExpandProperty Links | 
        Where-Object -FilterScript {$_.outerHtml -match $rgx} |
        Select-Object -ExpandProperty outerHtml | 
        Select-String -Pattern "https:\/\/..`*dotnet-sdk-$($new_app.Version)-win-x86.exe" |
        Select-Object -ExpandProperty Matches -First 1 | 
        Select-Object -ExpandProperty Value
