...
$new_app.Icon = "https://github.com/OptechX/library.apps.images/raw/main/$($Env:applicationCategory)/dotnet-6.0/Desktop%20Runtime/icon.png"
...
$new_app.Summary = "The .NET Desktop Runtime enables you to run existing Windows desktop applications."
...
else
{
    ...
    $x = Get-MSDotNetPackageDetails -VersionUrl $version_url `
        ...
        -SubsFilename "windowsdesktop-runtime-<REPLACE>-win-x86.exe" `
        -AbsoluteUrl "https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-desktop-<REPLACE>-windows-x86-installer"
    $new_app.Version = $x[0]
