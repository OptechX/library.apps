...
$new_app.Name = "Windows Terminal (Win10)"
$new_app.Lcid = @("en-US")
$new_app.CpuArch = @("x64")
...
$new_app.Icon = "https://github.com/OptechX/library.apps.images/raw/main/$($Env:applicationCategory)/Microsoft/Windows%20Terminal/Windows%2010/logo.png"
...
$new_app.Summary = "Windows Terminal (for Windows 10) is a new, modern, feature-rich, productive terminal application for command-line users."
...
else
{
    ...
    $asset_pattern = "*Win10*.msixbundle"
